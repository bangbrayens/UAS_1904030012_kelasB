...
$listbuku = query("SELECT * FROM daftar_buku");

if (isset($_POST['cari'])) {
  $listbuku = caribk($_POST['keyword']);
}
    ...
    <div class="container px-4 px-lg-5">
      <div class="row gx-4 gx-lg-5">
        <div class="col-md-10 col-lg-8 mx-auto text-center table-responsive">
          ...
          <h2 class="text-white mb-5">Daftar Buku</h2>
          <!-- * * * * * * * * * * * * * * *-->
          ...
          <form action="" method="POST">
            <input type="text" id="keyword" size="50" name="keyword" placeholder="masukan judul buku" autocomplete="off">
            ...
            <tbody>
              ...
              <?php foreach ($listbuku as $buku) : ?>
                <tr>
                  ...
                  <td><img src="assets/img/<?php echo $buku['cover_buku']; ?>" width="100px"></td>
                  <td><a href="detailbk.php?id=<?= $buku['id']; ?>" class="btn btn-warning" role="button">detail</a></td>
                </tr>
                <?php $no++ ?>
              <?php endforeach ?>
            </tbody>
